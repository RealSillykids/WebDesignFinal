(function ($) {
	...
	$(document).on("click", ".naccs5 .menu div", function() {
		var numberIndex = $(this).index();
	
		if (!$(this).is("active")) {
			$(".naccs5 .menu div").removeClass("active");
			$(".naccs5 ul li").removeClass("active");
	
			$(this).addClass("active");
			$(".naccs5 ul").find("li:eq(" + numberIndex + ")").addClass("active");
	
			var listItemHeight = $(".naccs5 ul")
				.find("li:eq(" + numberIndex + ")")
				.innerHeight();
			$(".naccs5 ul").height(listItemHeight + "px");
		}
	});
